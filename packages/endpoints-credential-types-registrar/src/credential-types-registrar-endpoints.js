...
const credentialTypesRegistrarEndpoints = async (fastify) =>
  fastify
    .register(AutoLoad, {
    ...
    // to register /schemas without an `/api/v0.6` prefix
    .register(schemasController, {
      prefix: '/schemas',
    });

module.exports = {
  credentialTypesRegistrarEndpoints: fp(credentialTypesRegistrarEndpoints),
};
