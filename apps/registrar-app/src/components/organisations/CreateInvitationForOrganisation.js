...
import { LINKEDIN_ORGANIZATION_ID, SUPPORT_EMAIL_HINT, TECHNICAL_EMAIL_HINT } from '../../utils';
import { validateEmail, validateWebsite, validateName } from './CreateOrganisation.utils';
...
import OrganizationAuthorityRadioGroup, {
  getDefaultAuthority,
} from '../../pages/organizations/components/OrganizationAuthorityRadioGroup';
...
const CreateInvitationForOrganisation = ({ onSubmit, countryCodes, onCancel, defaultValues }) => {
...
// eslint-disable-next-line better-mutation/no-mutation
CreateInvitationForOrganisation.propTypes = {
...
export default CreateInvitationForOrganisation;
