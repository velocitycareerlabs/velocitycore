...
import { copyTextToClipboard, objectToString } from '../../utils';
import downloadTxtAsFile from '../../utils/downloadTxtAsFile';
import { validateServiceEndpoint } from '../../components/organisations/CreateOrganisation.utils';
...
const isAddButtonDisabled = (inProgress, isIssueOrInspection, selectedCAO, serviceEndpoint) => {
  ...
  if (isIssueOrInspection && serviceEndpoint && selectedCAO) {
    return false;
  }
  if (!isIssueOrInspection && serviceEndpoint) {
    return false;
  }
  return true;
};
