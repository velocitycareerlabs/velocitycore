...
import SecretKeysPopup from './SecretKeysPopup';
import WarningSecretKeysPopup from '../../components/common/WarningSecretKeysPopup';
...
import { formatWebSiteUrl, formatRegistrationNumbers, parseJwt } from '../../utils';
...
const CreateOrganisationFromInvitation = () => {
  ...
  useEffect(() => {
    ...
    if (inviteeEmail && userEmail && userEmail !== inviteeEmail) {
      ...
      logout(auth0, window.location.href, true);
    }
  }, [userData, invitationData, logout, auth0]);
