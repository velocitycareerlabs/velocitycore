...
import CreateInvitationForOrganisation from '../../components/organisations/CreateInvitationForOrganisation';
...
import SetInvitationService from '../../components/invitations/SetInvitationService';
import MESSAGE_CODES from '../../constants/messageCodes';
import SetKeyIndividuals from '../../components/invitations/SetKeyIndividuals';
import { formatWebSiteUrl, formatRegistrationNumbers } from '../../utils';
...
const InvitationCreateForm = () => {
  ...
  useEffect(() => {
    if (isStep2 && !organizationProfileData) {
      redirect('/invitations/create/step-1');
    }
    if (isStep3 && !organizationProfileData) {
      redirect('/invitations/create/step-1');
    }
      ...
      <Box sx={{ width: '524px' }}>
        {isStep1 && (
          <>
            ...
            <CreateInvitationForOrganisation
              buttonTitle="Next"
